...
Cursor_t defaultCursor;

struct FontAttribute defaultAttr;

void initDefaultFont()
{

    defaultAttr.cwidth = 8;
    defaultAttr.cheight = 16;
}
...
void initCursor()
{
    initDefaultFont();
    defaultCursor.x = 0;
    defaultCursor.y = defaultAttr.cheight;
}
...
void incrementCursor()
{
    ...
    if (currentX > kernelInfo.width - defaultAttr.cwidth && currentY <= kernelInfo.height)
        setCursor(0, currentY + defaultAttr.cheight);
    else
        setCursor(currentX + defaultAttr.cwidth, currentY);
}
